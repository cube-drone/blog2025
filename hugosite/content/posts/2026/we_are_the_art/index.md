...
Why do **I** want to create art? It's not <small>just</small> because I demand the validation that comes from adulation from an adoring {{<sidenote audience>}}I wouldn't say no to a little adulation, though.{{</sidenote>}}. It's because I want to shape myself into the sort of person I'd want to hang out with at parties, because **nobody is forced to spend more time with me than I am** so it is best if I don't completely suck. 
